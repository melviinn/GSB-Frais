...
class __TwigTemplate_ed49bb9d86b33ec7c28be0cb105b58ed extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        if ((isset($context["error"]) || array_key_exists("error", $context) ? $context["error"] : (function () { throw new RuntimeError('Variable "error" does not exist.', 15, $this->source); })())) {
            // line 16
            echo "                    <div class=\"error-msg\"><i class=\"fas fa-warning\"></i>";
    ...
    {
        return array (  169 => 35,  164 => 33,  147 => 18,  141 => 16,  139 => 15,  136 => 14,  126 => 13,  114 => 9,  109 => 8,  99 => 7,  80 => 5,  68 => 42,  66 => 13,  62 => 11,  60 => 7,  56 => 6,  52 => 5,  46 => 1,);
    }
...
<html>
    ...
    <body>
        {% block body %}
            <div class=\"box\">
                {% if error %}
                    <div class=\"error-msg\"><i class=\"fas fa-warning\"></i>{{ error.messageKey|trans(error.messageData, 'security') }}</div>
                {% endif %}
                <form method=\"post\">
                    <div class=\"login-box\">
                        <div class=\"form-login\">
